...
<body>
  ...
  <section>
    ...
    <form action="/login" name="login" method="post">
      ...
      <button type="button" onclick="modalBtn()">로그인</button>
      <br>
      <br>
      <a href="https://kauth.kakao.com/oauth/authorize?response_type=code&client_id=cca39232502c8598754c9a360e9d0771&redirect_uri=http://localhost:8000/kakao/oauth">
       <img onclick="kakaoBtn()" src="/images/kakao_login_large_wide.png" style="width:455px;" />
      </a>
    </form>
