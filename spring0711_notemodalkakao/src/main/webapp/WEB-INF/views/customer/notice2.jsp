						...
						<table summary="NO, 제목, 등록일, 조회수 순으로 공지사항을 조회 하실수 있습니다." class="orderTable2" border="1" cellspacing="0">
							...
							<tbody>
								<!-- <tr>
 								...
 								<c:forEach var="memCustDto" items="${list}">
								<tr>
									<td class="tnone">${memCustDto.customerDto.bno}</td>
									<td class="left">
										<a href="#" class="lightgray">${memCustDto.customerDto.btitle}</a>
									</td>
									<td>
									    <fmt:formatDate value="${memCustDto.customerDto.bdate}" pattern="yyyy-MM-dd"/>
									</td>
									
									<td class="tnone right">${memCustDto.customerDto.bhit }</td>
								</tr>
 								</c:forEach>
